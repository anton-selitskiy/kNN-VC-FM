...
from vocos.modules import ConvNeXtBlock, ResBlock1, AdaLayerNorm, ConvNeXtBlockExport
...
class VocosBackbone(Backbone):
    ...
    def __init__(
        ...
        print('layer_scale_init_value: ', layer_scale_init_value)
...
class VocosBackboneExport(Backbone):
    """
    Vocos backbone module built with ConvNeXt blocks. Supports additional conditioning with Adaptive Layer Normalization
